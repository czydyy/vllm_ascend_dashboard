...
class SkillRegistry:
    ...
    def _resolve_builtin_skills_dir(self) -> Path:
        # Development: <repo>/backend/agent/skill_registry.py ->
        # <repo>/backend/.agents/skills.  Container: /app/agent/... ->
        # /app/.agents/skills.  Dockerfile copies backend/.agents there.
